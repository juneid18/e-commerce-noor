...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    postData.append("category", formData.category.join(",")); 
        ...
        <div class="navcontainer">
          <nav class="nav">
            <div class="nav-upper-options">
              ...
              <Link href={'./Users'} class="nav-option option3" style={{
                    backgroundColor: "#fff",
                    color: "#3f0097",
                    border: "none",
                  }}>
              ...
              <Link href={"./Contactus"}>
              <div className="nav-option option6" style={{
                    backgroundColor: "#fff",
                    color: "#3f0097",
                    border: "none",
                  }}>
        ...
        <div class="main">
          ...
          <div class="report-container">
            <div class="report-header">
              <h1 class="recent-Articles">Upload Iteam</h1>
            </div>
